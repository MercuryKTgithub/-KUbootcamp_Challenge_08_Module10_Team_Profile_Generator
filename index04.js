...
var engr2 = {
   name: "Tracy Tran",
   id: "102T",
   email: "TracyTr@social.com",
   github: "trishGH"
};
var engr3 = {
   name: "Benson J. Lee",
   id: "108T",
   email: "BensonJL@social.com",
   github: "BensonGH"
};
...
function peekResult(){
   ...
   // console.log(managerTeamSample);
   // console.log(engineerTeamSample);  
   // console.log(internTeamSample);  
   // const pageHTML = generatePage(managerTeamSample[0], engineerTeamSample, internTeamSample);
   const pageHTML = generatePage(managerTeam[0], engineerTeam, internTeam);
   fs.writeFile('dist/myteam.html', pageHTML, err => 
   {
   if (err) throw new Error(err);
   console.log('Page created! Check out myteam.html in this directory to see it!');
   });
}
